        ...
        <footer>
            <div className='block text-center md:flex flex-wrap justify-between items-center bg-gray-200 px-20 py-20 '>
                ...
                <div className='mt-5 md:block'>
                    <NavLink to={'/'} className={'mx-4 block md:block lg:inline p-[14px] rounded-[14px] hover:bg-gray-300'}>Home</NavLink>
                    <NavLink to={'/image-generator'}className={'mx-4 block md:block lg:inline p-[14px] rounded-[14px] hover:bg-gray-300'}>Image Generator</NavLink>
                    <NavLink to={'/create-pin'}className={'mx-4 block md:block lg:inline p-[14px] rounded-[14px] hover:bg-gray-300'}>Create Pin</NavLink>
                    <NavLink to={'/show-pins'}className={'mx-4 block md:block lg:inline p-[14px] rounded-[14px] hover:bg-gray-300'}>Show Pins</NavLink>
                </div>
